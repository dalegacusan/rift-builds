...
export const ERROR = {
	...
	DOES_NOT_HAVE_THREE_TO_SIX_PRIMARY_ITEMS: `A build must have at least ${Validation.ITEMS.PRIMARY.MIN_LENGTH} - ${Validation.ITEMS.PRIMARY.MAX_LENGTH} primary items`,
	...
	NOT_VALID_NUMBER_OF_ITEMS_SELECTED: `There can only be ${Validation.ITEMS.PRIMARY.MIN_LENGTH} - ${Validation.ITEMS.PRIMARY.MAX_LENGTH} Primary items and up to ${Validation.ITEMS.OPTIONAL.MAX_LENGTH} Optional items`,
